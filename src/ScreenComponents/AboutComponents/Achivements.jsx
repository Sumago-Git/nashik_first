        ...
        <Container fluid className='mt-lg-5 mt-4  pe-lg-5 '>
          <text>
            <ul className='listtext text-start pb-lg-4 ms-lg-4'>
              ...
              <li>Starting up <span style={{ fontWeight: "800" }}>“Knowledge Hub“</span>, a library consisting of books, Video/Audio CDs/DVDs related to <span style={{ fontWeight: "800" }}>Traffic Management and simulators for teaching driving techniques to citizens during training sessions.</span></li>
              <li>Various innovative <span style={{ fontWeight: "800" }}>Traffic Awareness Campaigns</span> conducted every year during<span style={{ fontWeight: "800" }}> Road Safety Week.</span></li>
              <li>Our efforts to start the two flyovers of Thane-Bhiwandi bypass on National Highway no. 3. to improve the connectivity of <span style={{ fontWeight: "800" }}>Nashik and Mumbai</span> were successful.<span style={{ fontWeight: "800" }}> Mumbai Metropolitan Region Development Authority (MMRDA)</span> opened both the flyovers for the public which was pending since years.</li>
              <li><span style={{ fontWeight: "800" }}>Aika Na Nashikkar :</span> Another succesfull road safety<span style={{ fontWeight: "800" }}> awareness campaign</span> which was launched in two parts.</li>
            </ul>
          </text>
        </Container>
      </Container>
