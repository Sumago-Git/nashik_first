        ...
        <Container fluid className='mt-lg-5 mt-4  pe-lg-5 '>
          <text>
            <ul className='listtext text-start pb-lg-4 ms-lg-4'>
              ...
              <li className='mb-lg-2'>A well appreciated creative campaign <span style={{ fontWeight: "800" }}> like DON (Dost Of Nashik), Aikana Nashikkar, etc</span> to create traffic rule <span style={{ fontWeight: "800" }}>awareness among youth.</span></li>
