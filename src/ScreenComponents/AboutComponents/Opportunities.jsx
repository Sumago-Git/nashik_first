...
const opportunitiesData = [
    ...
    { imgSrc: transport, text: 'Mass transport', marginTop: '-50px' },
    { imgSrc: animal, text: 'Stray Dog &<br /> Animals', marginTop: '-50px' },
    { imgSrc: pollution, text: 'Environment and <br />Pollution', marginTop: '-50px', pb: true },
];

const Opportunities = () => {
    return (
        <>
            <Container fluid className='oppobg mt-1  pb-5 '>
