    ...
    <>
      <Container fluid className='mt-lg-5 mt-5 p-0'>
        ...
        <Container fluid className='p-0 vbg '>
          <Row className='justify-content-center p-2 m-0'>
            ...
            <Col lg={6}>
            <img src={icons1} className='w-100 h-75 ms-lg-3  mt-lg-3 pt-lg-4 mt-4' />
            </Col>
            <Col >
              <p className='vtext text-middle mt-lg-3 pt-lg-3  mt-3 pt-5' >Nashik city will be <span style={{ fontWeight: "800" }}>Clean, Green, Safe,
      ...
      <Container fluid className='mt-lg-0 p-0 mt-3 '>
        <Container fluid className='p-0 mbg'>
           <Row className='justify-content-center p-2 m-0'>
            <Col lg={6} className='mt-lg-3 pt-lg-4 mt-0 '>
            <img src={m1} className='missionimg mx-4'/>
            <img src={m2} className='missionimg mx-4'/>
            <img src={m3} className='missionimg mx-5'/>
            </Col>
            ...
            <p className='mtext text-middle mt-4 pt-2 ps-2 m-0'> <span style={{ fontWeight: "800",color:"#F96945" }}>"Nashik First"</span> is a proactive group of citizens
