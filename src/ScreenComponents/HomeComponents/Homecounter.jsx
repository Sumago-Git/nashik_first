  ...
  return (
    <>
      ...
      <Container fluid className='pitch mt-4 pb-5'>
        {/* <div> */}
          <Row className='justify-content-center ms-lg-5 ps-lg-5 w-75'>
            <text className='ms-lg-5 ps-lg-5'>
              ...
              {/* <Col  > */}
                <Col  xl={7} xxl={10} md={10} lg={10} className='mt-4 whitebox'>
                  ...
                  <Row className=' ms-lg-5 mx-1 mt-lg-3 whiteboxbtn '>
                    <Col xs={6} sm={4} md={3} className='mb-3 mb-md-0'>
                ...
                <Col  xl={8} xxl={10} md={12} sm={12} className='mt-4   whitebox'>
                  <div>
                  ...
                  <Row className=" whiteboxbtn ms-lg-5 mt-lg-3 ">
                    ...
                    <Col xs={10} sm={6} md={6} lg={7}>
                      <div className='license pt-lg-2 pt-md-1 text-center' style={{ width: "320px" }}>
