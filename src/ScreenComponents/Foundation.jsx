        ...
        <Row className='d-flex align-items-center'>
          <Col lg={7} className=''>
            <text className='Fheadline ms-lg-5' style={{ fontWeight: "650", color: "#c50c1c" }}>The Advantage
              ...
              <p className='fpara1'><span style={{ color: "#c50c1c", fontWeight: "800" }}>Nashik</span> <span style={{ color: "#F96945", fontWeight: "800" }}> First</span>, an initiative of <span style={{ fontWeight: "800" }}>Advantage Nashik</span>
          ...
          <Col lg={5} className='p-0 justify-content-end'>
            ...
            <img src={group} className='group img-fluid flex-end ' />
